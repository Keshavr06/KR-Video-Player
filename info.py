...
ADMIN = int(environ.get('ADMIN', '7045947967'))
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002798630908'))
...
LINK_URL = environ.get("LINK_URL", "https://videoplayer7.blogspot.com/2025/06/video-player.html?m=1#")
